...
def updateHand(hand, word):
    ...
    for every_letter in word:
        if test_hand[every_letter] > 0:
            test_hand[every_letter] = test_hand[every_letter] - 1
    return test_hand            
...
def playHand(hand, wordList, n):
    ...
    while calculateHandlen(hand) > 0:
        ...
        user_input = input("enter a word or '.' to indicate the end of playing: ")
        if user_input == '.':
            break
        if not isValidWord(user_input, hand, wordList):
            print("Enter a valid Word")
        else:
            total_score = total_score + getWordScore(user_input, HAND_SIZE)
            hand = updateHand(hand, user_input)
    print("You ran out of hand words!")        
    return total_score         
    ...
    while True:
        ...
        if start_input == 'n':
            ...
            print(playHand(hand, wordList, HAND_SIZE))
                ...
                print(playHand(copy_hand, wordList, HAND_SIZE))
        elif start_input == 'e':
